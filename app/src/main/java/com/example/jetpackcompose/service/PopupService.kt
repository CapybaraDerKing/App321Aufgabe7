...
class PopupService : Service() {
    ...
    override fun onCreate() {
        ...
        // Erstelle den Notification-Channel
        createNotificationChannel()

        // Starte den Foreground-Service mit einer initialen Benachrichtigung
        startForegroundService()

        // Registriere den Broadcast-Receiver und initialisiere den Timer
        registerUpdateReceiver()
        initializeTimerFromSettings()
    }

    private fun startForegroundService() {
        val notification = getNotification("Service gestartet")
